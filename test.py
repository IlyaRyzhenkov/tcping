...
class HeaderCreator:
    def __init__(self, source_ip, dest_ip, source_port, dest_port, seq_num):
        ...
        self.ip_version_length = b'\x45\x00\x00\x34'  # version 4, IHL 5, type of service, Total length 52
        ...
        self.TCP_header_len_flags = b'\x80\x02' #length 8 (32)bytes, SYN flag
        self.window_size = b'\xfa\xf0' #64240
    ...
    def make_SYN_quarry(self):
        IP_header = self.ip_version_length + self.ip_fragmentation + self.ttl_tcp_protocol + self.source_ip + self.dest_ip +\
               self.IP_checksum
...
creator = HeaderCreator('10.10.10.2', '10.10.10.1', source_port, dest_port, 418816488)
