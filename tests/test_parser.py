...
class TestParser(unittest.TestCase):
    def test_parse1(self):
        ...
        packet = TCPPacketParser.Parser(data)
    ...
    def test_filter(self):
        packet1 = TCPPacketParser.Parser(b'asdadsadadadadsasdasdasdasdadadsasdadasdadsasdasdasdasdasdad')
        packet1.source_ip = '1.1.1.1'
        packet2 = TCPPacketParser.Parser(b'asdasdasdasdasdasdasdasdasdasdasdasdasdasdadsasdasdasdasdasd')
